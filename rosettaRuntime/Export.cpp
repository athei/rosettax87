...
init_library_t orig_init_library;
register_runtime_routine_offsets_t orig_register_runtime_routine_offsets;
translator_use_t8027_codegen_t orig_translator_use_t8027_codegen;
translator_reset_t orig_translator_reset;
ir_create_bad_access_t orig_ir_create_bad_access;
ir_create_t orig_ir_create;
module_free_t orig_module_free;
module_get_size_t orig_module_get_size;
module_is_bad_access_t orig_module_is_bad_access;
module_print_t orig_module_print;
translator_translate_t orig_translator_translate;
translator_free_t orig_translator_free;
translator_get_data_t orig_translator_get_data;
translator_get_size_t orig_translator_get_size;
translator_get_branch_slots_offset_t orig_translator_get_branch_slots_offset;
translator_get_branch_slots_count_t orig_translator_get_branch_slots_count;
translator_get_branch_entries_t orig_translator_get_branch_entries;
translator_get_instruction_offsets_t orig_translator_get_instruction_offsets;
translator_apply_fixups_t orig_translator_apply_fixups;
x87_init_t orig_x87_init;
x87_state_from_x86_float_state_t orig_x87_state_from_x86_float_state;
x87_state_to_x86_float_state_t orig_x87_state_to_x86_float_state;
x87_pop_register_stack_t orig_x87_pop_register_stack;
x87_f2xm1_t orig_x87_f2xm1;
x87_fabs_t orig_x87_fabs;
x87_fadd_ST_t orig_x87_fadd_ST;
x87_fadd_f32_t orig_x87_fadd_f32;
x87_fadd_f64_t orig_x87_fadd_f64;
x87_fbld_t orig_x87_fbld;
x87_fbstp_t orig_x87_fbstp;
x87_fchs_t orig_x87_fchs;
x87_fcmov_t orig_x87_fcmov;
x87_fcom_ST_t orig_x87_fcom_ST;
x87_fcom_f32_t orig_x87_fcom_f32;
x87_fcom_f64_t orig_x87_fcom_f64;
x87_fcomi_t orig_x87_fcomi;
x87_fcos_t orig_x87_fcos;
x87_fdecstp_t orig_x87_fdecstp;
x87_fdiv_ST_t orig_x87_fdiv_ST;
x87_fdiv_f32_t orig_x87_fdiv_f32;
x87_fdiv_f64_t orig_x87_fdiv_f64;
x87_fdivr_ST_t orig_x87_fdivr_ST;
x87_fdivr_f32_t orig_x87_fdivr_f32;
x87_fdivr_f64_t orig_x87_fdivr_f64;
x87_ffree_t orig_x87_ffree;
x87_fiadd_t orig_x87_fiadd;
x87_ficom_t orig_x87_ficom;
x87_fidiv_t orig_x87_fidiv;
x87_fidivr_t orig_x87_fidivr;
x87_fild_t orig_x87_fild;
x87_fimul_t orig_x87_fimul;
x87_fincstp_t orig_x87_fincstp;
x87_fist_i16_t orig_x87_fist_i16;
x87_fist_i32_t orig_x87_fist_i32;
x87_fist_i64_t orig_x87_fist_i64;
x87_fistt_i16_t orig_x87_fistt_i16;
x87_fistt_i32_t orig_x87_fistt_i32;
x87_fistt_i64_t orig_x87_fistt_i64;
x87_fisub_t orig_x87_fisub;
x87_fisubr_t orig_x87_fisubr;
x87_fld_STi_t orig_x87_fld_STi;
x87_fld_constant_t orig_x87_fld_constant;
x87_fld_fp32_t orig_x87_fld_fp32;
x87_fld_fp64_t orig_x87_fld_fp64;
x87_fld_fp80_t orig_x87_fld_fp80;
x87_fmul_ST_t orig_x87_fmul_ST;
x87_fmul_f32_t orig_x87_fmul_f32;
x87_fmul_f64_t orig_x87_fmul_f64;
x87_fpatan_t orig_x87_fpatan;
x87_fprem_t orig_x87_fprem;
x87_fprem1_t orig_x87_fprem1;
x87_fptan_t orig_x87_fptan;
x87_frndint_t orig_x87_frndint;
x87_fscale_t orig_x87_fscale;
x87_fsin_t orig_x87_fsin;
x87_fsincos_t orig_x87_fsincos;
x87_fsqrt_t orig_x87_fsqrt;
x87_fst_STi_t orig_x87_fst_STi;
x87_fst_fp32_t orig_x87_fst_fp32;
x87_fst_fp64_t orig_x87_fst_fp64;
x87_fst_fp80_t orig_x87_fst_fp80;
x87_fsub_ST_t orig_x87_fsub_ST;
x87_fsub_f32_t orig_x87_fsub_f32;
x87_fsub_f64_t orig_x87_fsub_f64;
x87_fsubr_ST_t orig_x87_fsubr_ST;
x87_fsubr_f32_t orig_x87_fsubr_f32;
x87_fsubr_f64_t orig_x87_fsubr_f64;
x87_fucom_t orig_x87_fucom;
x87_fucomi_t orig_x87_fucomi;
x87_fxam_t orig_x87_fxam;
x87_fxch_t orig_x87_fxch;
x87_fxtract_t orig_x87_fxtract;
x87_fyl2x_t orig_x87_fyl2x;
x87_fyl2xp1_t orig_x87_fyl2xp1;
sse_pcmpestri_t orig_sse_pcmpestri;
sse_pcmpestrm_t orig_sse_pcmpestrm;
sse_pcmpistri_t orig_sse_pcmpistri;
sse_pcmpistrm_t orig_sse_pcmpistrm;
is_ldt_initialized_t orig_is_ldt_initialized;
get_ldt_t orig_get_ldt;
set_ldt_t orig_set_ldt;
execution_mode_for_code_segment_selector_t orig_execution_mode_for_code_segment_selector;
mov_segment_t orig_mov_segment;
abi_for_address_t orig_abi_for_address;
determine_state_recovery_action_t orig_determine_state_recovery_action;
get_segment_limit_t orig_get_segment_limit;
translator_set_variant_t orig_translator_set_variant;

runtime_cpuid_t orig_runtime_cpuid;
runtime_wide_udiv_64_t orig_runtime_wide_udiv_64;
runtime_wide_sdiv_64_t orig_runtime_wide_sdiv_64;

constexpr std::array kExportList{
    Export{(void*)&init_library,
           "__ZN7rosetta7runtime7library12init_libraryEPKNS1_10SymbolListEyPKNS_20ThreadContextOffsetsE"},
    Export{(void*)&register_runtime_routine_offsets,
    ...
    Export{(void*)&translator_translate,
           "__ZN7rosetta7runtime7library20translator_translateEPKNS1_12ModuleResultE15TranslationMode"},
    ...
    Export{(void*)&translator_get_branch_slots_offset,
           "__ZN7rosetta7runtime7library34translator_get_branch_slots_offsetEPKNS1_17TranslationResultE"},
    Export{(void*)&translator_get_branch_slots_count,
           "__ZN7rosetta7runtime7library33translator_get_branch_slots_countEPKNS1_17TranslationResultE"},
    Export{(void*)&translator_get_branch_entries,
           "__ZN7rosetta7runtime7library29translator_get_branch_entriesEPKNS1_17TranslationResultE"},
    Export{(void*)&translator_get_instruction_offsets,
           "__ZN7rosetta7runtime7library34translator_get_instruction_offsetsEPKNS1_17TranslationResultE"},
    Export{(void*)&translator_apply_fixups,
           "__ZN7rosetta7runtime7library23translator_apply_fixupsEPNS1_17TranslationResultEPhy"},
    Export{(void*)&x87_init, "__ZN7rosetta7runtime7library8x87_initEPNS1_8X87StateE"},
    Export{(void*)&x87_state_from_x86_float_state,
           "__ZN7rosetta7runtime7library30x87_state_from_x86_float_stateEPNS1_8X87StateEPKNS0_15X86FloatState64E"},
    Export{(void*)&x87_state_to_x86_float_state,
           "__ZN7rosetta7runtime7library28x87_state_to_x86_float_stateEPKNS1_8X87StateEPNS0_15X86FloatState64E"},
    ...
    Export{(void*)&x87_fld_constant,
           "__ZN7rosetta7runtime7library16x87_fld_constantEPNS1_8X87StateENS_10translator3x8711X87ConstantE"},
    ...
    Export{(void*)&execution_mode_for_code_segment_selector,
           "__ZN7rosetta7runtime7library40execution_mode_for_code_segment_selectorEjt"},
    Export{(void*)&mov_segment,
           "__ZN7rosetta7runtime7library11mov_segmentEjPNS1_16SegmentRegistersENS1_15SegmentRegisterEt"},
    Export{(void*)&abi_for_address, "__ZN7rosetta7runtime7library15abi_for_addressEy"},
    Export{(void*)&determine_state_recovery_action,
           "__ZN7rosetta7runtime7library31determine_state_recovery_actionEPKjjj"},
...
__attribute__((section("__DATA,exports"))) Exports kExports = {
    0x1560000000000, kExportList.data(), kExportList.size(), kRuntimeExportList.data(), kRuntimeExportList.size(),
};

// this is filled in by loader with the exports of libRosettaRuntime
__attribute__((section("__DATA,imports"))) Exports kImports = {
    0x0, 0x0, 0x0, 0x0, 0x0,
};
